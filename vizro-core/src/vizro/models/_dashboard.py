...
class Dashboard(VizroBaseModel):
    ...
    pages: list[Page]
    theme: Literal["vizro_dark", "vizro_light", "vizro_modern"] = Field(
        default="vizro_modern", description="Theme to be applied across dashboard. Defaults to `vizro_dark`."
    )
            ...
            children=[
                ...
                dcc.Store(
                    ...
                    data={
                        ...
                        "vizro_modern": pio.templates.merge_templates("vizro_modern", dashboard_overrides),
                    },
                ),
